...
test('assets 4.5.3 quebram o cache antigo em todas as páginas',()=>{
  const pages=[];
  ...
  for(const file of pages){
    ...
    if(html.includes('/style.css'))assert.match(html,/style\.css\?v=20260901-v453/,path.relative(root,file));
  }
});
