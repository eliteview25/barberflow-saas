...
test('assets 4.1.2 quebram o cache antigo em todas as páginas',()=>{
  const pages=[];
  ...
  for(const file of pages){
    ...
    if(html.includes('/style.css'))assert.match(html,/style\.css\?v=20260830-v412/,path.relative(root,file));
  }
});
