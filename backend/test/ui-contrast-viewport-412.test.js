...
test('assets 4.5.4 quebram o cache antigo do CSS em todas as páginas',()=>{
  const pages=[];
  ...
  for(const file of pages){
    ...
    if(html.includes('/style.css'))assert.match(html,/style\.css\?v=20260902-v457/,path.relative(root,file));
  }
});
