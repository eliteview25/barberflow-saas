# EliteFlow 3.2.0 — Perfis e Mobile Fit

## Objetivo

A versão 3.2.0 refina a experiência do EliteFlow por função e corrige fontes estruturais de overflow em telas pequenas.
