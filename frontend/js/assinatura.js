if(requireAuth(['dono'])){
  ...
  function renderCatalog(){
    ...
    const enterprise=`<article class="plan plan-enterprise"><span class="plan-badge">ESCALA</span><h2>Enterprise</h2><h3>Sob consulta</h3><p class="muted">Para operações com 11 ou mais profissionais.</p><div class="plan-limit">11+ profissionais</div><ul class="plan-feature-list"><li>✓ Recursos Premium</li><li>✓ Condições comerciais personalizadas</li><li>✓ Implantação e dimensionamento conforme operação</li></ul><a class="btn btn-secondary" href="/pages/suporte.html">Falar com o EliteFlow</a></article>`;
