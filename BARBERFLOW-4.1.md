...
## Visual
- Layout estrutural redesenhado a partir da identidade visual BarberFlow: sidebar compacta, topbar com busca, notificações e foto do dono, dashboard com gráficos reais, ranking e agenda.
...
- Se a API criar a assinatura sem devolver `init_point`, o BarberFlow usa o `preapproval_id` para abrir o checkout oficial.
