# BarberFlow 4.4.0 — Construtor de Fluxos do WhatsApp
...
A personalização não substitui as validações transacionais do backend. Serviço, profissional, data, disponibilidade do horário, tenant, cliente e pagamento continuam sendo validados pelo BarberFlow.
