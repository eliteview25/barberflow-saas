# EliteFlow 3.0 — operação completa

A versão 3.0 transforma o EliteFlow em uma suíte operacional focada em barbearias. A Loja pública permanece fora da navegação e desligada por padrão; produtos continuam integrados ao PDV e estoque.
...
- IA no WhatsApp: interpretação opcional de linguagem natural com ações limitadas pelas regras do EliteFlow e fallback para o fluxo determinístico.
