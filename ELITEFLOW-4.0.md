# EliteFlow 4.0.0 — Visual Premium + Checkout de cartão externo

## Identidade visual
- Design system carvão + âmbar inspirado na identidade oficial EliteFlow.
...
## Assinaturas
- Pix continua sendo gerado e acompanhado dentro do EliteFlow.
- Cartão não é mais coletado pelo frontend do EliteFlow.
